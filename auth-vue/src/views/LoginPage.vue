...
const loginSystem = async () => {
  try {
    const data = await login({ username: loginPass.login, password: loginPass.password })
...
<template>
  <div class="login">
    ...
    <div class="login_buttons">
      <ButtonComponent title="Register" @click="navigateToRegister" />
      <ButtonComponent title="Login" @click="loginSystem" />
    </div>
  </div>
</template>
